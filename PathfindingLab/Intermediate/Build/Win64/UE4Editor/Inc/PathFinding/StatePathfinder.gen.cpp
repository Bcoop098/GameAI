...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_ray_MetaData[];
#endif
		static void NewProp_ray_SetBit(void* Obj);
		static const UE4CodeGen_Private::FBoolPropertyParams NewProp_ray;
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray_MetaData[] = {
		{ "Category", "StatePathfinder" },
		{ "ModuleRelativePath", "Public/StatePathfinder.h" },
	};
#endif
	void Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray_SetBit(void* Obj)
	{
		((AStatePathfinder*)Obj)->ray = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray = { "ray", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(AStatePathfinder), &Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray_SetBit, METADATA_PARAMS(Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray_MetaData, ARRAY_COUNT(Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray_MetaData)) };
#if WITH_METADATA
	...
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AStatePathfinder_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AStatePathfinder_Statics::NewProp_ray,
	...
	IMPLEMENT_CLASS(AStatePathfinder, 219159276);
